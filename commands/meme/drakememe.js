...
module.exports = {
    ...
    noalias: [''],
    category: "image",
    description: "Sends a wubmeme image",
    ...
    run: async (bot, message, args) => {
        if(args[1] === "64") {
            ...
            if (!arg[1]) return message.channel.send("Usage: `drakememe [<32>/<64>] <text1> | <text2>`");
            if (arg[0].length > 230 || arg[1].length > 230) return message.channel.send("There's a 230 characters limit.");
            let font = await Jimp.loadFont(Jimp.FONT_SANS_32_BLACK);
            let meme = await Jimp.read("https://memetemplateindia.com/wp-content/uploads/2020/06/drake-meme-template-300x258.jpg");
            ...
            const attachment = new Discord.MessageAttachment(render, "drake.png");
